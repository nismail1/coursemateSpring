...
private PasswordEncoder passwordEncoder;
    ...
    public String loginUser(@RequestParam String username, @RequestParam String password, Model model) {
        ...
        SystemUser user = userService.authenticate(username, password);
        // System.out.println("CHECK IF THE USER IS NULL"+user.getRole()+"   "+user.getFirstName());
        if (user != null) {
    ...
    public String registerAdministrator(@RequestParam String firstName, 
        ...
        try {
            ...
            return "redirect:/dashboard/admin/" + admin.getId();  // Redirect to login after successful registration
        } catch (Exception e) {
            model.addAttribute("error", "Registration failed. Try again!");
