...
public class DashboardController {
    ...
    public String getStudentDashboard(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("title", "Student Dashboard");
           // Retrieve the student's grades and add them to the model
        List<Grade> studentGrades = studentService.getGradesByStudent(id);
    ...
    public String getTeacherDashboard(@PathVariable Long id, Model model) {
        System.out.println("HERE IS WHERE i CHECK THE TEACHER LOKA TT ME");
    ...
    public String getAdminDashboard(@PathVariable Long id, Model model) {
        System.out.println("HERE IS WHERE i CHECK THE ADMIN");
        ...
        // Pass all teachers, students, and courses to the model
